...
var message = "hello";
var runProducer = function () { return __awaiter(void 0, void 0, void 0, function () {
    var connection, channel, queueName, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 7:
                error_1 = _a.sent();
                console.error('Error in producer:', error_1);
                return [3 /*break*/, 8];
